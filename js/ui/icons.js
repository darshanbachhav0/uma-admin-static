/**
 * Inline SVG icon set (Lucide geometry, ISC licensed, embedded locally so the
 * app does not depend on an icon CDN). Icons are used instead of emoji for all
 * application controls.
 *
 * The markup below is authored in this repository and never contains user data.
 */
...
export function icon(name, options = {}) {
  ...
  // Static markup defined above — never user input.
